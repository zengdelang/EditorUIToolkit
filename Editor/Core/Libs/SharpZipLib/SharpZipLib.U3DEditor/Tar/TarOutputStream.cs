...
namespace SharpZipLib.U3DEditor.Tar
{
	...
	public class TarOutputStream : Stream
	{
		...
		/// <summary>
		/// Get the record m_Size being used by this stream's TarBuffer.
		/// </summary>
		...
		public override void Write(byte[] buffer, int offset, int count)
		{
			...
			if ((currBytes + count) > currSize) {
				string errorText = string.Format("request to write '{0}' bytes exceeds m_Size in header of '{1}' bytes",
					count, this.currSize);
