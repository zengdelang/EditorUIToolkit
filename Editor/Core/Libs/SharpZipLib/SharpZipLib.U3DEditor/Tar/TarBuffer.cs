...
namespace SharpZipLib.U3DEditor.Tar
{
	...
	/// m_Size, or other tars will complain.
	/// <p>
	...
	public class TarBuffer
	{
		...
		written at the full m_Size, with blocks after the zero block containing
		...
		*/
		...
		#region Constants
		/// <summary>
		/// The m_Size of a block in a tar archive in bytes.
		/// </summary>
		...
		/// <summary>
		/// The m_Size in bytes of a default record.
		/// </summary>
		/// <remarks>
		/// The default m_Size is 10KB.
		/// </remarks>
		public const int DefaultRecordSize = BlockSize * DefaultBlockFactor;
		#endregion

		/// <summary>
		/// Get the record m_Size for this buffer
		/// </summary>
		/// <value>The record m_Size in bytes.
		...
		/// <summary>
		/// Get the TAR Buffer's record m_Size.
		/// </summary>
		/// <returns>The record m_Size in bytes.
		...
		public void WriteBlock(byte[] block)
		{
			...
			if (block.Length != BlockSize) {
				string errorText = string.Format("TarBuffer.WriteBlock - block to write has length '{0}' which is not the block m_Size of '{1}'",
		...
		public void WriteBlock(byte[] buffer, int offset)
		{
			...
			if ((offset + BlockSize) > buffer.Length) {
				string errorText = string.Format("TarBuffer.WriteBlock - record has length '{0}' with offset '{1}' which is less than the record m_Size of '{2}'",
