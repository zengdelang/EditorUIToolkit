...
namespace SharpZipLib.U3DEditor.Zip.Compression.Streams
{
	...
	public class InflaterInputBuffer
	{
		#region Constructors
		/// <summary>
		/// Initialise a new instance of <see cref="InflaterInputBuffer"/> with a default buffer m_Size
		/// </summary>
		...
		/// </summary>
		/// <param name="stream">The stream to buffer.</param>
		/// <param name="bufferSize">The m_Size to use for the buffer</param>
		/// <remarks>A minimum buffer m_Size of 1KB is permitted.  Lower sizes are treated as 1KB.</remarks>
	...
	public class InflaterInputStream : Stream
	{
		...
		/// and a default buffer m_Size of 4KB.
		/// </summary>
		...
		/// <summary>
		/// Create an InflaterInputStream with the specified decompressor
		/// and the specified buffer m_Size.
		/// </summary>
		/// <param name = "baseInputStream">
		/// The InputStream to read bytes from
		/// </param>
