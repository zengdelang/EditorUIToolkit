...
namespace SharpZipLib.U3DEditor.Zip.Compression.Streams
{
	...
	public class DeflaterOutputStream : Stream
	{
		#region Constructors
		/// <summary>
		/// Creates a new DeflaterOutputStream with a default Deflater and default buffer m_Size.
		/// </summary>
		...
		/// The buffer m_Size in bytes to use when deflating (minimum value 512)
		/// </param>
