...
namespace SharpZipLib.U3DEditor.Zip
{
	...
	{
		/// <summary>
		/// Get /set the compressed m_Size of data.
		/// </summary>
		...
		/// <summary>
		/// Get / set the uncompressed m_Size of data
		/// </summary>
		public long Size {
			get { return size; }
			set { size = value; }
	...
	internal class ZipHelperStream : Stream
	{
		...
		/// <param name="minimumBlockSize">Minimum m_Size of the block.</param>
		...
		/// <param name="sizeEntries">The m_Size of entries in the central directory.</param>
		...
		public void WriteZip64EndOfCentralDirectory(long noOfEntries, long sizeEntries, long centralDirOffset)
		{
			...
			WriteLELong(44);    // Size of this record (total m_Size of remaining fields in header or full m_Size - 12)
			...
			WriteLELong(centralDirOffset);  // offset of start of central directory
											// zip64 extensible data sector not catered for here (variable m_Size)
		...
		/// <param name="sizeEntries">The m_Size of the entries in the directory.</param>
