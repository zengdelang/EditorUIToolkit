...
namespace SharpZipLib.U3DEditor.Core
{
	...
	/// <summary>
	/// ExtendedPathFilter filters based on name, file m_Size, and the last write time of the file.
	/// </summary>
	...
	public class ExtendedPathFilter : PathFilter
	{
		...
		/// <param name="minSize">The minimum file m_Size to include.</param>
		/// <param name="maxSize">The maximum file m_Size to include.</param>
		...
		#region Properties
		/// <summary>
		/// Get/set the minimum m_Size/length for a file that will match this filter.
		/// </summary>
		...
		/// <summary>
		/// Get/set the maximum m_Size/length for a file that will match this filter.
		/// </summary>
	...
	/// <summary>
	/// NameAndSizeFilter filters based on name and file m_Size.
	/// </summary>
	...
	public class NameAndSizeFilter : PathFilter
	{
		...
		/// <summary>
		/// Get/set the minimum m_Size for a file that will match this filter.
		/// </summary>
		public long MinSize {
			get { return minSize_; }
			set {
		...
		/// <summary>
		/// Get/set the maximum m_Size for a file that will match this filter.
		/// </summary>
		public long MaxSize {
			get { return maxSize_; }
			set {
