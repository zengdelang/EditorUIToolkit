...
namespace SharpZipLib.U3DEditor.BZip2
{
	...
	public class BZip2OutputStream : Stream
	{
		...
		#region Constructors
		/// <summary>
		/// Construct a default output stream with maximum block m_Size
		/// </summary>
		...
		/// <param name="blockSize">The block m_Size to use.</param>
		/// <remarks>
		...
		void EndBlock()
		{
			...
			For a compressed file of m_Size 100Gb -- about 100000 blocks --
		...
		The current block m_Size is 100000 * this number.
		--*/
		int blockSize100k;
