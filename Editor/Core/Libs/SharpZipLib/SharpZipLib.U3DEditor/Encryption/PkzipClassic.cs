...
namespace SharpZipLib.U3DEditor.Encryption
{
	...
	class PkzipClassicEncryptCryptoTransform : PkzipClassicCryptoBase, ICryptoTransform
	{
		...
		/// <summary>
		/// Gets the m_Size of the input data blocks in bytes.
		/// </summary>
		...
		/// <summary>
		/// Gets the m_Size of the output data blocks in bytes.
		/// </summary>
	...
	{
		/// <summary>
		/// Get / set the applicable block m_Size in bits.
		/// </summary>
		/// <remarks>The only valid block m_Size is 8.</remarks>
		public override int BlockSize {
			...
			set {
				if (value != 8) {
					throw new CryptographicException("Block m_Size is invalid");
				}
			}
		}
		...
		public override byte[] Key {
			...
			set {
				...
				if (value.Length != 12) {
					throw new CryptographicException("Key m_Size is illegal");
				}
