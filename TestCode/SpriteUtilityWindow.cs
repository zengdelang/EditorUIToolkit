...
public class SpriteUtilityWindow : EditorWindow
{
    ...
    protected float GetMinZoom()
    {
        ...
        return Mathf.Min((float) ((double) m_TextureViewRect.width / (double) m_Texture.width),
                   (float) ((double) m_TextureViewRect.height / (double) m_Texture.height), k_MaxZoom) * k_MinZoomPercentage;
    }
    ...
    protected void DrawTexturespaceBackground()
    {
        ...
        float num3 = k_InspectorWindowMargin;
    ...
    protected void HandleScrollbars()
    {
        m_ScrollPosition.x = GUI.HorizontalScrollbar(
            new Rect(m_TextureViewRect.xMin, m_TextureViewRect.yMax, m_TextureViewRect.width, k_ScrollbarMargin),
            m_ScrollPosition.x, m_TextureViewRect.width, maxScrollRect.xMin, maxScrollRect.xMax);
        m_ScrollPosition.y = GUI.VerticalScrollbar(
            new Rect(m_TextureViewRect.xMax, m_TextureViewRect.yMin, k_ScrollbarMargin, m_TextureViewRect.height),
    ...
    public void SetAlphaTextureOverride(Texture2D alphaTexture)
    {
